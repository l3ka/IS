    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('konobarKreira', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='konobar_kreirao', to='base.Konobar')),
                ('konobarProcesira', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='konobar_procesirao', to='base.Konobar')),
            ],
        ),
        migrations.CreateModel(
            name='NarudzbaStavka',
